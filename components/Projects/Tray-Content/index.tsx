  ...
  return (
    <div className="flex flex-col gap-4">
      <div className="flex justify-between items-center pb-6 border-b-[1px] border-neutral-100">
        <h1 className="font-semibold tracking-tight text-xl">Options</h1>
      ...
      <div className="flex flex-col gap-3">
        ...
        >
          <Lock className="h-4 w-4 text-black tracking-tight" /> 
  ...
  return (
    <div className="flex flex-col gap-4">
      <div className="flex flex-col gap-3 pb-6 border-b-[1px] border-neutral-100">
        ...
        <h1 className="font-semibold tracking-tight text-xl">Secret Recovery Phrase</h1>
        <p className="tracking-tight text-black">
    ...
    <div className="flex flex-col gap-4">
      <div className="flex flex-col gap-3">
        ...
        <p className="tracking-tight text-[15px] text-black">
          Inbox is a secure online platform for sending and recieving electronic messages, it is a free to use, web-based email service accessible through web browsers.
        </p>
        <p className="tracking-tight text-[15px] text-black">
          Inbox is integrated with our other service InMeet, enabling productivity and smooth collaboration
        </p>
        <div className='justify-end gap-1 flex-col items-end flex'>
            <h1 className="tracking-tighter font-semibold items-center">Inbox &copy; 2025</h1>
  ...
  return (
    <div className="flex flex-col gap-4">
      <div className="flex flex-col gap-3">
        ...
        <h1 className="font-semibold tracking-tight text-xl">Are you sure?</h1>
        <p className="tracking-tight text-black">
          You haven't backed up your emails yet. If you remove it, you could
          lose access forever. We suggest backing up your emails
...
export const RemoveEmails = ({ setContent, closeTray }: ContentProps) => {
  return (
    <div className="flex flex-col gap-4">
      <div className="flex flex-col gap-3">
        <div className="flex justify-between items-start ">
          <Trash className="h-8 w-8 text-gray-700" />
          <button className="" onClick={closeTray}>
            <X className="h-5 w-5 text-gray-700" />
          </button>
        </div>
        <h1 className="font-semibold tracking-tight text-xl">Deletion Complete</h1>
        <p className="tracking-tight text-[15px] text-black">
